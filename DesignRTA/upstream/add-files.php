        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade in active" id="modal-<?php echo $itemTypeSingular; ?>-data-wrapper">
                        <form id="the_<?php echo $itemTypeSingular; ?>" method="POST" data-type="<?php echo $itemTypeSingular; ?>" class="o-modal-form" enctype="multipart/form-data">
                            ...
                            <?php if (in_array('upstream_client_user', $user->roles)) { ?>
                                <div class="row upstream-file-title form_row_title">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        <input type="text" id="<?php echo $fieldPrefix . 'title'; ?>" name="data[title]" class="form-control" required>
                                    </div>
                            ...
                            <div class="row upstream-file-file form_row_file pt-3">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <button type="button" class="btn btn-default btn-xs o-media-library-btn" data-title="<?php esc_attr_e('File', 'upstream'); ?>" data-name="file">
            ...
            <div class="modal-footer">
                <div class="row" data-visible-when="edit">
                    <div class="col-md-12 col-sm-12 col-xs-12 text-right" id="add_comment_btn">
                        ...
                        <button type="submit" class="btn btn-success" form="the_<?php echo $itemTypeSingular; ?>">
                            ...
                            <div class="row upstream-file-description form_row_description">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <?php if ($allowComments) : ?>
                                        <div role="tabpanel" class="tab-pane fade" id="modal-<?php echo $itemTypeSingular; ?>-comments-wrapper" data-wrapper-type="comments">
                                            <?php if (upstream_permissions('publish_project_discussion')) :
                                                $editor_id = 'upstream_' . $itemTypePlural . '_comment_editor';
                                            ?>

                                                <textarea name="comment_field" id="designrta_revision_comment" cols="100" style="width: 100%; " rows="5"></textarea>
                                                <br>
                                                <br>
                                                <button data-uploading_info="" type="button" class="btn btn-primary" id="upload_revision_in_reply">Upload Revison &nbsp;<i class="fas fa-upload"></i></button>
                                                <br>

                                                <div id="uploading_file_name">
                                                </div>
                                                <div class="comments-controls-btns">
                                                    <button type="button" id="project_file_comment" class="btn btn-success" data-action="comments.add_comment" data-editor_id="<?php echo $editor_id; ?>" data-nonce="<?php echo wp_create_nonce('upstream:project.' . $itemTypePlural . '.add_comment'); ?>" data-item_type="<?php echo $itemTypeSingular; ?>" data-item_title=""><?php esc_html_e('Add Comment', 'upstream'); ?></button>
                                                </div>
                                            <?php endif; ?>
                                            <div class="c-comments" data-type="<?php echo $itemTypeSingular; ?>" data-nonce="<?php echo wp_create_nonce('upstream:project.' . $itemTypePlural . '.fetch_comments'); ?>"></div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                <div class="hidden-xs hidden-sm col-md-1 col-lg-1"></div>
