                            ...
                            <div class="card support-bar overflow-hidden">
                                ...
                                <div class="card-footer bg-success text-white">
                                    <div class="row text-center">
                                        ...
                                        <div class="col" style="border-left-color: #fff; border-left-style: solid; border-left-width: 2px;">
                                ...
                                <table class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($projectsList as $projectIndex => $project) : ?>
                                            ...
                                            ?>
                                            <tr class="t-row-<?php echo $isProjectIndexOdd ? 'odd' : 'even'; ?> <?php echo  $project_class; ?>" data-id="<?php echo $project->id; ?>">
                                                ...
                                                <?php if (upstream_override_access_field(true, UPSTREAM_ITEM_TYPE_PROJECT, $project->id, null, 0, 'title', UPSTREAM_PERMISSIONS_ACTION_VIEW)) : ?>
                                                    <td data-column="title" data-value="<?php echo esc_attr($project->title); ?>">
                                                        <div class="d-inline-block align-middle">
                                                            <span class="img-radius wid-40 align-top m-r-15"><?php echo get_avatar(get_the_author_meta("id")); ?></span>
                                                            <div class="d-inline-block">
                                                                <h6><?php do_action('upstream:frontend.project.details.before_title', $project); ?>
                                                                    <?php echo esc_html($project->title); ?>
                                                                </h6>
                                                                <p class="text-muted m-b-0">
                                                                    <a href="<?php echo esc_url($project->permalink); ?>" style="color: #053E89;">
                                                                        View Project
                                                                    </a>
                                                                </p>
                                                            </div>
                                                ...
                                                <?php if (upstream_override_access_field(true, UPSTREAM_ITEM_TYPE_PROJECT, $project->id, null, 0, 'start', UPSTREAM_PERMISSIONS_ACTION_VIEW)) : ?>
                                                    <td data-column="startDate" data-value="<?php echo esc_attr($project->startDateTimestamp); ?>">
                                                ...
                                                <?php if (upstream_override_access_field(true, UPSTREAM_ITEM_TYPE_PROJECT, $project->id, null, 0, 'end', UPSTREAM_PERMISSIONS_ACTION_VIEW)) : ?>
                                                    <td data-column="endDate" data-value="<?php echo esc_attr($project->endDateTimestamp); ?>">
                                                ...
                                                <?php if (upstream_override_access_field(true, UPSTREAM_ITEM_TYPE_PROJECT, $project->id, null, 0, 'categories', UPSTREAM_PERMISSIONS_ACTION_VIEW)) : ?>
                                                    ...
                                                    <td data-column="categories" data-value="<?php echo count($project->categories) ? esc_attr(implode(
                                                        ...
                                                        if (!empty($project->status)) {
                                                            ...
                                                            <?php } else { ?>
                                                                <div id="counter_<?php echo $project->id; ?>" style="background-color:#f5f5f5; color: rgb(0, 0, 0);padding: 5px;"><?php echo $project->modified_at ?></div>
                                                        <?php }
                                                        } ?>
                                                    ...
                                                    <script>
                                                        ...
                                                        let countDownDate_<?php echo $project->id; ?> = new Date("<?php echo $project->modified_at; ?>").getTime();
                                                        ...
                                                        var x = setInterval(function() {
                                                            ...
                                                            document.getElementById("counter_<?php echo $project->id; ?>").innerHTML = days + "d " + hours + "h " + minutes + "m " + seconds + "s ";

                                                            // If the count down is over, write some text
                                                            if (distance < 0) {
                                                                clearInterval(x);
                                                                document.getElementById("counter_<?php echo $project->id; ?>").innerHTML = "EXPIRED";
                                                            }
                                                        }, 1000);
                                                    </script>
                                                <?php else : ?>
