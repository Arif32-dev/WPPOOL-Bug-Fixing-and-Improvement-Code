                                    ...
                                    <div class="col-md-6">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>Project Overview: (<?php echo get_the_title(get_the_ID()) ?>)</h5>
                                            </div>
                                            <div class="card-body">
                                                                            ...
                                                                            <div class="o-comment__body">
                                                                                ...
                                                                                <div class="o-comment__body__right">
                                                                                    ...
                                                                                    <div class="o-comment__body__footer">
                                                                                        ...
                                                                                        <!-- Upload Button -->
                                                                                        <a data-item-id="<?php echo $file_value['id'] ?>" data-file_id="<?php echo $file_value['file_id'] ?>" data-project-id="<?php echo get_the_ID() ?>" data-comment_id="<?php echo $comment->comment_ID ?>" data-toggle="modal" href="#" class="comment_revision_file_upload">
